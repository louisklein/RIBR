// ** Initialize globals **
  ...
  // ** Task and trial parameters **
    ...
    var distractor_task_duration =  2000;// 120000;
  ...
  // ** Set up like judgment task **
    var like_judgment_instructions = {
        type: 'instructions',
        pages: ['<p>Great job! In the final phase of the experiment, you will be shown statements that you may have already seen today.</p>'+
                '<p>For each statement, you will need to rate how much you like or dislike it.</p>'+
                ...
                '<p><i>Press the spacebar to continue to the next page...</i></p>',
                "<p>For each rating, try not to think about why you like or dislike each statement; just go with your intuitions or 'gut feelings'.</p>"+
  ...
  jsPsych.init({
      ...
      on_finish: function(data)
        {
          window.location.assign("https://mq-psy.sona-systems.com/webstudy_credit.aspx?experiment_id=3359&credit_token=ea2e1c4c03144a499547b899bb7835c6&survey_code="+sona_id)
	      }
  })